...
const {
	searchBar: {
		...
		placeholder: {
			placeholderColor: defaultPlaceholderTextColor,
		...
		autocomplete: {
			autocompleteTextColor: defaultAutocompleteTextColor,
			...
			autocompleteFontSize: defaultAutocompleteOptionFontSize,
			autocompleteFontWeight: defaultAutocompleteOptionFontWeight,
			autocompleteLineHeight: defaultAutocompleteOptionLineHeight,
